...
import Terms from './admin/terms.js'
import AdminHeader from './admin_header.js'
    ...
    render() { 
        return (
            <div  className="sidebar-main" >
                {/* HeaderIn Block */}
                <AdminHeader open={this.openMenu}/>
                ...
                <div className="sidebar">
                    ...
                    <a href="#" onClick={() => this.state.count = 3}><i className="fas fa-sliders-h" aria-hidden="true"></i><span>Terms And Conditions</span></a>
